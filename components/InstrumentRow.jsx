...
const InstrumentRow = ({ droppableProvidedInfo, instrument, measureId }) => {
  ...
  return (
    <div
      ref={droppableProvidedInfo.innerRef}
      {...droppableProvidedInfo.droppableProps}
    ...
    >
      {
        ...
        [1, 2, 3, 4, 5].map((instrument_number) => {
          ...
          } else return <InstrumentImage key={instrument_number} instrument={instrument} number={instrument_number} />;
        })
      }
    </div>
  );
